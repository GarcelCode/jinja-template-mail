from data_files.global_values import appUrl, user, company, cfdi_issued, cfdi_received, cfdi_efos, cfdi_issued_canceled, cfdi_received_canceled, date
